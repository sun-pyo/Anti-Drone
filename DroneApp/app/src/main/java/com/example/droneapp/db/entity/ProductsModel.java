...
public class ProductsModel implements ListItem {
    ...
    public ProductsModel(String caminfo,long numOfDrone, double distance, long date) {
    ...
    public void setCaminfo(String caminfo){this.caminfo = caminfo;}
    public String getCaminfo(){return caminfo;}
